...
export type Path = (typeof TABS)[number]['path'] | 'settings' | 'item' | 'recipe' | 'insights' | 'faye' | 'labels' | 'quick'
const KNOWN: Path[] = ['today', 'stock', 'plan', 'recipes', 'shop', 'settings', 'item', 'recipe', 'insights', 'faye', 'labels', 'quick']
